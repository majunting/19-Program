...
void off_display();
# 3 "FT800.c" 2
# 1 "F:\\Microchip\\XC8\\pic\\include\\c99\\string.h" 1 3
# 25 "F:\\Microchip\\XC8\\pic\\include\\c99\\string.h" 3
# 1 "F:\\Microchip\\XC8\\pic\\include\\c99\\bits/alltypes.h" 1 3
# 409 "F:\\Microchip\\XC8\\pic\\include\\c99\\bits/alltypes.h" 3
typedef struct __locale_struct * locale_t;
# 25 "F:\\Microchip\\XC8\\pic\\include\\c99\\string.h" 2 3
...
char *strerror (int);
# 65 "F:\\Microchip\\XC8\\pic\\include\\c99\\string.h" 3
...
void wr8(unsigned long addr, ft_uint8_t value){
    LATDbits.LATD0 = 0;
    SPI_Exchange8bit(0x80 | (addr >> 16));
    SPI_Exchange8bit(addr >> 8);
...
void wr16(unsigned long addr, ft_uint16_t value){
    ...
    SPI_Exchange8bit(addr >> 8);
    SPI_Exchange8bit(addr);
    SPI_Exchange8bit((value) & 0xFF);SPI_Exchange8bit(((value) >> 8) & 0xFF);
    LATDbits.LATD0 = 1;
}
...
void wr32(unsigned long addr, ft_uint32_t value){
    ...
    SPI_Exchange8bit(addr >> 8);
    SPI_Exchange8bit(addr);
    SPI_Exchange8bit(((value) & 0xFFFF) & 0xFF);SPI_Exchange8bit((((value) & 0xFFFF) >> 8) & 0xFF);SPI_Exchange8bit((((value) >> 16) & 0xFFFF) & 0xFF);SPI_Exchange8bit(((((value) >> 16) & 0xFFFF) >> 8) & 0xFF);
    LATDbits.LATD0 = 1;
}
...
void cmd(ft_uint32_t command){
    wr32(1081344UL + cmd_offset, command);cmd_incrementn(4);
}
# 139 "FT800.c"
void off_display() {
...
__attribute__((inline)) void FT800_Init(){
    ...
    wr8(1057892UL, 0);
    wr8(1057884UL, 0);
    wr16(1057880UL, 0x01B6);
    wr8(1057888UL, 0x0000);
    ...
    wr32(1048576UL +0,((2UL<<24)|(((0)&255UL)<<16)|(((26)&255UL)<<8)|(((0)&255UL)<<0)));
    wr32(1048576UL +4,((38UL<<24)|(((1)&1UL)<<2)|(((1)&1UL)<<1)|(((1)&1UL)<<0)));
    wr32(1048576UL +8,((0UL<<24)));
    ...
    cmd_offset=rd16(1058024UL);while(rd16(1058020UL) != cmd_offset);
