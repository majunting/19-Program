...
inline void FT800_Init(){
    ...
    host_command(FT_ACTIVE); //send host command "ACTIVE" to FT800

    host_command(FT_CLKEXT); //send command to "CLKEXT" to FT800

    host_command(FT_CLK48M); //send command to "CLKEXT" to FT800
