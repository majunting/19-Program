...
# 18 "F:\Microchip\XC8\pic\include\xc.h"
extern const char __xc8_OPTIM_SPEED;

extern double __fpnormalize(double);


# 13 "F:\Microchip\XC8\pic\include\c90\xc8debug.h"
#pragma intrinsic(__builtin_software_breakpoint)
extern void __builtin_software_breakpoint(void);

# 52 "F:\Microchip\XC8\pic\include\pic18f25k80.h"
...
# 18 "F:\Microchip\XC8\pic\include\pic18.h"
...
# 13 "F:\Microchip\XC8\pic\include\c90\stdint.h"
...
# 13 "F:\Microchip\XC8\pic\include\c90\stdbool.h"
...
# 4 "F:\Microchip\XC8\pic\include\__size_t.h"
typedef unsigned size_t;

# 6 "F:\Microchip\XC8\pic\include\c90\stddef.h"
typedef int ptrdiff_t;

# 84 "mcc_generated_files/i2c.h"
typedef enum
{
...
# 23 "mcc_generated_files/../BNO055.h"
typedef struct
{
...
while( I2C_MasterQueueIsFull() == 1 );
writeBuffer[0] = BNO055_CHIP_ID_ADDR;
I2C_MasterWrite( writeBuffer, 1, (0x28), &flag );
while( flag == I2C_MESSAGE_PENDING );
if( flag == I2C_MESSAGE_COMPLETE) {
while( I2C_MasterQueueIsFull() == 1 );
I2C_MasterRead ( message, 1, (0x28), &flag );
while ( flag == I2C_MESSAGE_PENDING );
id = message[0];
if ( id != (0xA0) ){
flag = I2C_MESSAGE_PENDING;
writeBuffer[0] = BNO055_CHIP_ID_ADDR;
I2C_MasterWrite( writeBuffer, 1, (0x29), &flag );
while( flag == I2C_MESSAGE_PENDING );
if( flag == I2C_MESSAGE_COMPLETE) {
flag = I2C_MESSAGE_PENDING;
I2C_MasterRead ( message, 1, (0x29), &flag );
while ( flag == I2C_MESSAGE_PENDING );
id = message[0];
}
if ( id != (0xA0) ) {
